...
import time
import pytz  # Required for India Timezone fix

app = Flask(__name__)
voting_blockchain = Blockchain()

# --- 1. CONFIGURATION & VOTER DATABASE ---
# Default times (Admin can change these live on the website)
voting_config = {
...
def cast_vote():
    ...
    # Security: Check if Student ID is authorized
...
def admin_results():
    tally = {}
    # Skip Genesis block and calculate totals
    ...
    # Pass 'config' to allow the Time Edit form to work
